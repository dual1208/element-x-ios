...
public final nonisolated class CompoundUIColors {
    ...
    // swiftformat:disable numberFormatting blankLinesBetweenScopes
    ...
    public var _bgCodeBlock: UIColor {
        Self.backgroundCodeBlock
    }
    /// A concurrency-safe accessor for code that doesn't need runtime colour overrides.
    public static var backgroundCodeBlock: UIColor {
        coreTokens.gray100
    }
    /// A concurrency-safe fallback for attributed strings that have no foreground colour.
    public static var primaryText: UIColor {
        CompoundUIColorTokens().textPrimary
    }
    /// This token is a placeholder and hasn't been finalised.
    @available(iOS, deprecated: 100000.0, message: "This token should be generated by now.")
    public let _bgSubtleSecondaryAlpha = coreTokens.alphaGray300
    // swiftformat:enable numberFormatting blankLinesBetweenScopes
}
