...
struct CallScreen_Previews: PreviewProvider {
    ...
    static func makeViewModel() -> CallScreenViewModel {
        ...
        widgetDriver.startBaseURLClientIDColorSchemeVoiceOnlyLanguageTagAllowMediaEncryptionRageshakeURLAnalyticsConfigurationReturnValue = .success(URL.userDirectory)
